library UISkill initializer init
    ...
    private function Action takes nothing returns nothing
        ...
        call DzFrameSetTexture(BanAdens[1],"Bandi_Aden1.blp",0)
        ...
        set BanAdens[2] = DzCreateFrameByTagName("BACKDROP", "", frame, "", 0)
        call DzFrameSetTexture(BanAdens[2],"Bandi_Aden2.blp",0)
        call DzFrameSetAbsolutePoint(BanAdens[2],JN_FRAMEPOINT_CENTER,0.4,0.035)
        call DzFrameSetSize(BanAdens[2],0.06,0.06)
        call DzFrameShow(BanAdens[2], false)
        set BanAdens[3] = DzCreateFrameByTagName("BACKDROP", "", frame, "", 0)
        call DzFrameSetTexture(BanAdens[3],"Bandi_Aden3.blp",0)
        call DzFrameSetAbsolutePoint(BanAdens[3],JN_FRAMEPOINT_CENTER,0.4,0.035)
        call DzFrameSetSize(BanAdens[3],0.06,0.06)
        call DzFrameShow(BanAdens[3], false)

        set BanAdens2[0]=DzCreateFrameByTagName("SPRITE", "", frame, "", 0)
        call DzFrameSetAbsolutePoint(BanAdens2[0],JN_FRAMEPOINT_BOTTOMLEFT,0.4,0.035)
        call DzFrameShow(BanAdens2[0], false)
        set BanAdens2[1]=DzCreateFrameByTagName("SPRITE", "", frame, "", 0)
        call DzFrameSetAbsolutePoint(BanAdens2[1],JN_FRAMEPOINT_BOTTOMLEFT,0.4,0.040)
        call DzFrameShow(BanAdens2[1], false)
        set BanAdens2[2]=DzCreateFrameByTagName("SPRITE", "", frame, "", 0)
        call DzFrameSetAbsolutePoint(BanAdens2[2],JN_FRAMEPOINT_BOTTOMLEFT,0.4,0.045)
        call DzFrameShow(BanAdens2[2], false)
        set BanAdens2[3]=DzCreateFrameByTagName("SPRITE", "", frame, "", 0)
        call DzFrameSetAbsolutePoint(BanAdens2[3],JN_FRAMEPOINT_BOTTOMLEFT,0.4,0.050)
        call DzFrameShow(BanAdens2[3], false)
        set BanAdens2[4]=DzCreateFrameByTagName("SPRITE", "", frame, "", 0)
        call DzFrameSetAbsolutePoint(BanAdens2[4],JN_FRAMEPOINT_BOTTOMLEFT,0.4,0.055)
