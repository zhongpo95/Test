library UIBossStart initializer Init requires UIHP, Boss2, Boss1, Boss4, FrameCount, UIOverlay, UIMainQuest, UIPick
    globals
        ...
        integer array FBS_BLL[12][4]       //보스리스트 잠금
    ...
    private function RefreshBossLocks takes integer pid returns nothing
        call DzFrameShow(FBS_BLL[0][1], not CanPickBoss(pid, 2))
        call DzFrameShow(FBS_BLL[0][2], not CanPickBoss(pid, 1))
        call DzFrameShow(FBS_BLL[0][3], not CanPickBoss(pid, 3))
    endfunction
    ...
    private function BSOpen takes nothing returns nothing
        ...
        if FBS_OnOff[GetPlayerId(DzGetTriggerUIEventPlayer())] == true then
            ...
            call RefreshBossLocks(GetPlayerId(DzGetTriggerUIEventPlayer()))
    ...
    if true then
        ...
        call DzFrameSetAbsolutePoint(FBS_BT[0], JN_FRAMEPOINT_CENTER, 0.2600, 0.5025)
        call DzFrameShow(FBS_BT[0], true)
        
        set FBS_BLB[0][1] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[0], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[0][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        ...
        set FBS_BLL[0][1]=DzCreateFrameByTagName("BACKDROP", "", FBS_BT[0], "template", FrameCount())
        call DzFrameSetTexture(FBS_BLL[0][1], "UI_Inventory_Lock2.blp", 0)
        call DzFrameSetSize(FBS_BLL[0][1], 0.030, 0.030)
        call DzFrameSetAbsolutePoint(FBS_BLL[0][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        call DzFrameShow(FBS_BLL[0][1], false)
        
        set FBS_BLB[0][2] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[0], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[0][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        ...
        set FBS_BLL[0][2]=DzCreateFrameByTagName("BACKDROP", "", FBS_BT[0], "template", FrameCount())
        call DzFrameSetTexture(FBS_BLL[0][2], "UI_Inventory_Lock2.blp", 0)
        call DzFrameSetSize(FBS_BLL[0][2], 0.030, 0.030)
        call DzFrameSetAbsolutePoint(FBS_BLL[0][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        call DzFrameShow(FBS_BLL[0][2], false)
        
        set FBS_BLB[0][3] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[0], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[0][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[0][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
        set FBS_BLL[0][3]=DzCreateFrameByTagName("BACKDROP", "", FBS_BT[0], "template", FrameCount())
        call DzFrameSetTexture(FBS_BLL[0][3], "UI_Inventory_Lock2.blp", 0)
        call DzFrameSetSize(FBS_BLL[0][3], 0.030, 0.030)
        call DzFrameSetAbsolutePoint(FBS_BLL[0][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
        call DzFrameShow(FBS_BLL[0][3], false)
        
        
        set FBS_BossTip[0]=DzCreateFrameByTagName("BACKDROP", "", FBS_BT[0], "template", FrameCount())
        call DzFrameSetTexture(FBS_BossTip[0], "UI_BossTip0.blp", 0)
        call DzFrameSetSize(FBS_BossTip[0], 0.20, 0.30)
        call DzFrameSetAbsolutePoint(FBS_BossTip[0], JN_FRAMEPOINT_CENTER, 0.55, 0.39)
        call DzFrameShow(FBS_BossTip[0], false)
        set FBS_BossTip[1]=DzCreateFrameByTagName("BACKDROP", "", FBS_BT[0], "template", FrameCount())
        call DzFrameSetTexture(FBS_BossTip[1], "UI_BossTip1.blp", 0)
        call DzFrameSetSize(FBS_BossTip[1], 0.20, 0.30)
        call DzFrameSetAbsolutePoint(FBS_BossTip[1], JN_FRAMEPOINT_CENTER, 0.55, 0.39)
        call DzFrameShow(FBS_BossTip[1], false)
        set FBS_BossTip[2]=DzCreateFrameByTagName("BACKDROP", "", FBS_BT[0], "template", FrameCount())
        call DzFrameSetTexture(FBS_BossTip[2], "UI_BossTip2.blp", 0)
        call DzFrameSetSize(FBS_BossTip[2], 0.20, 0.30)
        call DzFrameSetAbsolutePoint(FBS_BossTip[2], JN_FRAMEPOINT_CENTER, 0.55, 0.39)
        call DzFrameShow(FBS_BossTip[2], false)
    endif
    //2페이지
    if true then
        ...
        call DzFrameSetAbsolutePoint(FBS_BT[1], JN_FRAMEPOINT_CENTER, 0.2600, 0.5025)
        call DzFrameShow(FBS_BT[1], false)
        
        set FBS_BLB[1][1] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[1], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[1][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[1][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        
        set FBS_BLB[1][2] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[1], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[1][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[1][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        
        set FBS_BLB[1][3] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[1], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[1][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[1][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
    endif
    //3페이지
    if true then
        ...
        call DzFrameSetAbsolutePoint(FBS_BT[2], JN_FRAMEPOINT_CENTER, 0.2600, 0.5025)
        call DzFrameShow(FBS_BT[2], false)
        
        set FBS_BLB[2][1] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[2], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[2][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[2][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        
        set FBS_BLB[2][2] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[2], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[2][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[2][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        
        set FBS_BLB[2][3] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[2], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[2][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[2][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
    endif
    //4페이지
    if true then
        ...
        call DzFrameSetAbsolutePoint(FBS_BT[3], JN_FRAMEPOINT_CENTER, 0.2600, 0.5025)
        call DzFrameShow(FBS_BT[3], false)
        
        set FBS_BLB[3][1] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[3], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[3][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[3][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        
        set FBS_BLB[3][2] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[3], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[3][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[3][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        
        set FBS_BLB[3][3] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[3], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[3][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[3][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
    endif
    ...
    if true then
        ...
        call DzFrameSetAbsolutePoint(FBS_BT[4], JN_FRAMEPOINT_CENTER, 0.2600, 0.5025)
        call DzFrameShow(FBS_BT[4], false)
        
        set FBS_BLB[4][1] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[4], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[4][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[4][1], JN_FRAMEPOINT_CENTER, 0.2600, 0.4150)
        
        set FBS_BLB[4][2] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[4], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[4][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[4][2], JN_FRAMEPOINT_CENTER, 0.2650, 0.3250)
        
        set FBS_BLB[4][3] = DzCreateFrameByTagName("BUTTON", "", FBS_BT[4], "ScoreScreenTabButtonTemplate", FrameCount())
        call DzFrameSetAbsolutePoint(FBS_BLB[4][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
        ...
        call DzFrameSetAbsolutePoint(FBS_BL[4][3], JN_FRAMEPOINT_CENTER, 0.2700, 0.2350)
    endif
