...
library UIMainQuest initializer Init requires FrameCount, UIItem
    ...
    private function Init takes nothing returns nothing
        ...
        call DzFrameSetPoint(F_MQTitleText, JN_FRAMEPOINT_TOPLEFT, F_MQBackDrop, JN_FRAMEPOINT_TOPLEFT, 0.010, -0.020)
        ...
        call DzFrameSetPoint(F_MQBodyText, JN_FRAMEPOINT_TOPLEFT, F_MQBackDrop, JN_FRAMEPOINT_TOPLEFT, 0.010, -0.040)
