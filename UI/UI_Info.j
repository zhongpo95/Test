library UIInfo initializer Init requires DataItem, StatsSet, UIItem, ITEM, FrameCount
    ...
    private function CreateEItemButton takes integer types, real x, real y returns nothing
        set F_EItemSlotBackDrop[types]=DzCreateFrameByTagName("BACKDROP", "", F_InfoBackDrop, "", FrameCount())
        ...
        call DzFrameSetTexture(F_EItemSlotBackDrop[types], "Empty.blp", 0)
    ...
    private function Main takes nothing returns nothing
        ...
        */
        ...
        call DzFrameSetTexture(F_ItemStatsIcon, "war3mapImported\\UI_Pick_Backdrop.tga", 0)
