...
많은 부분을 수정해야 한다면 반드시 나에게 물어보고 진행해.  
하나의 파일에 코드를 다 넣지 말고, 기능 별로 모듈화 해.  
요청이 명확하지 않을 때 추론 및 실행하지 말고 우선 내 설명을 제대로 이해했는지 말해.  
PR 생성하지 말고 로컬로만 작업해.
...
1. Run `multica issue get 7162db17-fd61-4873-b8ed-05bcd2f21f48 --output json` to understand the issue context
2. Run `multica issue metadata list 7162db17-fd61-4873-b8ed-05bcd2f21f48 --output json` to see what prior agents pinned — best-effort, empty `{}` and CLI failures are normal. See the `## Issue Metadata` section above for what to look for.
3. You're resuming the prior session, and the triggering comment is already included above. No other new comments on this issue since your last run. Use the active thread anchor `0f89074c-fb4e-499d-8480-fc35b7422415` and triggering comment ID `0d8a1ae4-2049-40ed-90b0-3637b8b61ab1`. If your reply depends on thread context, do not rely only on resumed session memory — first pull the triggering conversation with: `multica issue comment list 7162db17-fd61-4873-b8ed-05bcd2f21f48 --thread 0f89074c-fb4e-499d-8480-fc35b7422415 --tail 30 --output json`.

4. Find the triggering comment (ID: `0d8a1ae4-2049-40ed-90b0-3637b8b61ab1`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    # 2. Post the comment:
    multica issue comment add 7162db17-fd61-4873-b8ed-05bcd2f21f48 --parent 0d8a1ae4-2049-40ed-90b0-3637b8b61ab1 --content-file ./reply.md
