...
카드 탭은 조건 없이 화면을 열고 `부여 시작` 버튼에서 서버·빈 공간·재료를 확인한 뒤 재료 1개를 소모합니다. 진행 중인 카드는 탭을 왕복하거나 허브를 닫아도 유지됩니다. 카드부여와 엘릭서의 새 배치, 추가 텍스처, 결과 수령 및 검사 항목은 [카드부여·엘릭서 적용 안내](crafting-ui.md)에 있습니다.
