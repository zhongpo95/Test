...
모든 신규 텍스처는 비압축 32비트 BGRA TGA이며 크기는 2의 거듭제곱입니다. 배경 1024×1024, 인물 512×1024, 본문 512×512, 제목 512×128, 카드 512×256, 탭·강화 버튼 256×64, 닫기 64×64입니다. 전체 배경은 불투명하여 뒤의 게임 화면이 비치지 않습니다.

패널과 탭의 편집 가능한 SVG, 인물 원본 JPG, 미리보기와 가져오기 목록은 `assets/upgrade`에 있습니다. 최종 인물 텍스처는 사용자가 제공한 `462537.jpg`의 얼굴·상반신 영역을 직접 잘라서 변환한 것입니다. 검토용 ImageGen 이미지는 최종 게임 자산에 사용하지 않습니다. 인물 영역은 16:9 화면에서 비율이 맞도록 크롭한 후 POT 텍스처에 저장합니다. 4:3 및 다른 화면 비율은 게임에서 별도 확인이 필요합니다.
