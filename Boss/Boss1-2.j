library Boss2 requires Tick,DataUnit,UIBossHP,DamageEffect2,UIBossEnd,DataMap,Boss1,BossAggro,ItemPickUp,UIMainQuest,UIPick
    globals
        //무력화시간
    ...
    private function SuccessF takes nothing returns nothing
        ...
        call MainQuestAfterTutorialBoss(GetOwningPlayer(GetEnumUnit()), PlayerSlotNumber[GetPlayerId(GetOwningPlayer(GetEnumUnit()))], 1)
        ...
        //call AddReward(GetOwningPlayer(GetEnumUnit()), "ID39"+";"+"0")
        //확률드랍
        //call AddRandomReward(GetOwningPlayer(GetEnumUnit()), "ID39"+";"+"0", 100)
        //call AddRandomReward(GetOwningPlayer(GetEnumUnit()), "ID39"+";"+"0", 100)
        //call AddRandomReward(GetOwningPlayer(GetEnumUnit()), "ID39"+";"+"0", 100)
        //call AddRandomReward(GetOwningPlayer(GetEnumUnit()), "ID39"+";"+"0", 100)
        //call AddRandomReward(GetOwningPlayer(GetEnumUnit()), "ID39"+";"+"0", 100)
