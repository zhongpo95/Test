...
PORT=WORK/'hera-port'
OUT=pathlib.Path(os.environ.get('HERA_MAP_OUT',str(WORK/'Hera_RPG_Init_v167.w3x')))
OUT.parent.mkdir(parents=True,exist_ok=True)
SRC=WORK/'build-artifacts';SRC.mkdir(exist_ok=True)
TITLE='Hera RPG initialization v167'
