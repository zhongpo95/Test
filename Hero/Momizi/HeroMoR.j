...
private function splashD takes nothing returns nothing
    ...
    if IsUnitInRangeXY(GetEnumUnit(),splash.x,splash.y,distance) then
        ...
        if level >= 2 then
            if level >= 3 then
                call HeroDeal(splash.source,GetEnumUnit(),(HeroSkillVelue3[3]*2.72),false,false,false)
            else
                call HeroDeal(splash.source,GetEnumUnit(),(HeroSkillVelue3[3]*1.60),false,false,false)
            endif
        else
            call HeroDeal(splash.source,GetEnumUnit(),(HeroSkillVelue3[3]),false,false,false)
        endif
    endif
endfunction
