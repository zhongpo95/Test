...
endglobals
    ...
    private function Main takes nothing returns nothing
        ...
        if GetSpellAbilityId() == 'A01F' then
            ...
            call DelayCreate2(fx.target, 'e01Z', GetRandomReal(0,360), 3.0, 0.02, GetPlayerId(GetOwningPlayer(fx.caster)))
            call DelayCreate2(fx.target, 'e021', GetRandomReal(0,360), 3.0, 0.02, GetPlayerId(GetOwningPlayer(fx.caster)))
            call AnimationStart(fx.caster,11)
            call SetUnitFacing(fx.caster,AngleWBW(fx.caster,fx.target))
            call EXSetUnitFacing(fx.caster,AngleWBW(fx.caster,fx.target))
