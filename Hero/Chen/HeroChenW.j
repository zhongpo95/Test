...
globals
    ...
    private constant real CoolTime = 1.5
...
private function EffectFunction takes nothing returns nothing
    ...
    if GetUnitAbilityLevel(fx.caster, 'BPSE') < 1 and GetUnitAbilityLevel(fx.caster, 'A024') < 1 then
        call UnitEffectTime2('e00B',GetUnitX(fx.caster)+Polar.X( 150, GetUnitFacing(fx.caster) ),GetUnitY(fx.caster) + Polar.Y( 150, GetUnitFacing(fx.caster) ),GetUnitFacing(fx.caster)+90,0.5,1)
        ...
        if splash.range( splash.ENEMY, fx.caster, GetUnitX(fx.caster)+Polar.X( 150, GetUnitFacing(fx.caster) ), GetUnitY(fx.caster) +Polar.Y( 150, GetUnitFacing(fx.caster) ), scale, function splashD ) != 0 then
        endif
    endif
