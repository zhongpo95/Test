    ...
    if IsUnitInRangeXY(GetEnumUnit(),splash.x,splash.y,distance) then
        if IsUnitInGroup(GetEnumUnit(),CheckG) == false then
            ...
            if AngleTrue( GetUnitFacing(CheckU), AngleWBW(CheckU,GetEnumUnit()), 90 ) then
                ...
                call HeroDeal(1,splash.source,GetEnumUnit(),HeroSkillVelue5[14]*velue,false,false,false,false)
...
private function Main takes nothing returns nothing
    ...
    if GetSpellAbilityId() == 'A06J' then
        ...
        call CooldownFIX(fx.caster,'A06J',HeroSkillCD5[14])
    endif
endfunction
...
//! runtextmacro 이벤트_N초가_지나면_발동("B","2.0")
    ...
    set t=CreateTrigger()
    call DzTriggerRegisterSyncData(t,("BandiS2"),(false))
