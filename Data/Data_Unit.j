...
private function NPCTownRandomX takes integer column returns real
    local real cell = (NPC_TOWN_RIGHT - NPC_TOWN_LEFT) / 3.00
    return GetRandomReal(NPC_TOWN_LEFT + (cell * I2R(column)), NPC_TOWN_LEFT + (cell * I2R(column + 1)))
endfunction

private function NPCTownRandomY takes integer row returns real
    local real cell = (NPC_TOWN_TOP - NPC_TOWN_BOTTOM) / 3.00
    return GetRandomReal(NPC_TOWN_BOTTOM + (cell * I2R(row)), NPC_TOWN_BOTTOM + (cell * I2R(row + 1)))
endfunction
...
private function init takes nothing returns nothing
    ...
    set NPCUnit[5]  = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'h005', NPCTownRandomX(0), NPCTownRandomY(0), 319)
    ...
    set NPCUnit[6]  = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'h006', NPCTownRandomX(1), NPCTownRandomY(0), 335)
    ...
    set NPCUnit[7]  = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'h007', NPCTownRandomX(2), NPCTownRandomY(0), 270)
    ...
    set NPCUnit[9]  = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'h00A', NPCTownRandomX(0), NPCTownRandomY(1), 344)
    ...
    set NPCUnit[10]  = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'h00C', NPCTownRandomX(2), NPCTownRandomY(1), 244)
    ...
    set NPCUnit[11]  = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'h00D', NPCTownRandomX(0), NPCTownRandomY(2), 228)
    ...
    set NPCUnit[12]  = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE),'h00E', NPCTownRandomX(2), NPCTownRandomY(2), 244)
