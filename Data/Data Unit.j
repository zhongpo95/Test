...
//! runtextmacro 이벤트_N초가_지나면_발동("A","1.0")
    ...
    set HeroSkillID0[4] = 'A017'
    set HeroSkillID1[4] = 'A018'
    set HeroSkillID2[4] = 'A019'
    set HeroSkillID3[4] = 'A01A'
    set HeroSkillID4[4] = 'A01B'
    set HeroSkillID5[4] = 'A01C'
    set HeroSkillID6[4] = 'A01D'
    set HeroSkillID7[4] = 'A01E'
    set HeroSkillID8[4] = 'A01F'
    set HeroSkill0Text1[4] = "스킬 사용시 50.0% 확률로 재사용 대기시간이 4.9초 감소된다."
    set HeroSkill0Text2[4] = "적에게 주는 피해가 50.0% 증가된다." 
    set HeroSkill0Text3[4] = "적에게 주는 피해가 100.0% 증가된다."
    set HeroSkill1Text1[4] = ""
    ...
    set HeroSkill3Text1[4] = "공격속도가 27.0% 증가한다."
    set HeroSkill3Text2[4] = "적에게 주는 피해가 70.0% 증가한다."
    set HeroSkill3Text3[4] = "차지 조작으로 변경된다.　　　　　　2단계 차지 시 총 52.5%의 증가된 피해를 주며, 풀 차지 시 총 150.0%의 증가된 피해를 주지만, 1단계 차지 시 피해가 20.0% 감소된다."
    set HeroSkill4Text1[4] = "적에게 주는 피해가 100.0% 증가한다."
    set HeroSkill4Text2[4] = "풀 차지 시 마지막 공격의 피해가 100% 증가한다."
    set HeroSkill4Text3[4] = "풀 차지 시 마지막 공격의 피해가 89.1% 증가한다."
    set HeroSkill5Text1[4] = "적에게 주는 피해가 50.0% 증가한다."
    set HeroSkill5Text2[4] = "차지 단계가 올라갈수록 공격력이 30.0% 상승한다."
    set HeroSkill5Text3[4] = "풀 차지 시 적에게 주는 피해가 122% 증가한다."
    ...
    set HeroSkill7Text1[4] = "재사용 대기시간이 8.0초 감소한다."
    set HeroSkill7Text2[4] = "보호막 지속 시간이 6.0초 증가한다."
    set HeroSkill7Text3[4] = "보호막 수치가 자신의 최대 생명력의 40%로 변경된다."
